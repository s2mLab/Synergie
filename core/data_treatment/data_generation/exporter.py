    ...
    for i in jumpList:
        ...
        if jump_id != "0":
            ...
            # since videoTimeStamp is for user input, I can change it's value to whatever I want
                jumpDictCSV.append({'path': jump_id, 'videoTimeStamp': mstostr(i.startTimestamp), 'type': i.type.value, 'success': i.success.value, 'skater_name': i.skater_name, "rotations": "{:.1f}".format(i.rotation), "length": i.length})
